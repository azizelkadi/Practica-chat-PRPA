        ...
        try:
            ...
            if data_type == 'msg':
                ...
                if data == "quit":
                    ...
                    send_status_all(username, "deconection", clients, timestamp)
                    conn.close()
                ...
                # Comando
                    ...
                    if command == 'p':
                        ...
                        msg_conectados = ('Usuarios conectados:\n') + ('\n'.join(clients.keys()))
                        send_msg_private('Server', username, msg_conectados, clients, timestamp)
